...
export class CloudfrontDemoStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: cdk.StageProps) {
    ...
    //const config = this.node.tryGetContext("stages")[props.stage];//TODO: uncomment and add the configuration to cdk.json

    // SSL certificate 
    //const certificateArn = acm.Certificate.fromCertificateArn(this, "tlsCertificate", config.certificateArn); //TODO: add certificate ARN here
    ...
    let cloudFrontDist = new Distribution(this, "cloudfrontDist", {
      ...
      //domainNames: ["enlearacademy.tk"],//TODO: Domain Name Here
      //certificate: certificateArn, //TODO: Add certificate here
      defaultBehavior: {
